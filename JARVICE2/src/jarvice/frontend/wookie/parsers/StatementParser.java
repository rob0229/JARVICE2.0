...
public class StatementParser extends WookieParserTD {
	...
	protected static final EnumSet<WookieTokenType> STMT_START_SET = EnumSet
			.of(LEFT_BRACE, BEGIN, SWITCH, FOR, WookieTokenType.IF, ELSE_IF,
					DO, WHILE, IDENTIFIER, SEMICOLON);
	// CHANGED END TO RIGHT BRACE AND REMOVED UNTIL and DOT, ADDED
	// RETURN************************************************************
	// Synchronization set for following a statement.
	protected static final EnumSet<WookieTokenType> STMT_FOLLOW_SET = EnumSet
			.of(SEMICOLON, RIGHT_BRACE, RIGHT_PAREN, UNTIL, DOT, END, ELSE);
	...
	public ICodeNode parse(Token token) throws Exception {
		...
		// ROB****************ADDED LEFT_BRACE as beginning of compound
		// statement******************************************************
		...
		case IDENTIFIER: {
			...
			case FUNCTION: {
				AssignmentStatementParser assignmentParser = new AssignmentStatementParser(
						this);
				statementNode = assignmentParser
						.parseFunctionNameAssignment(token);
				break;
			}
		...
		case DO: {
			DoWhileStatementParser repeatParser = new DoWhileStatementParser(
					this);

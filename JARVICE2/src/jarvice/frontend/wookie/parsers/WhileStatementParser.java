...
public class WhileStatementParser extends StatementParser {
	...
	public ICodeNode parse(Token token) throws Exception {
		...
		// ROB ADDED THIS
		// DO NOT NEED NOT, c loops while(true), PASCAL loops
		// while(FALSE)************************************
		// ICodeNode notNode =
		// ICodeFactory.createICodeNode(ICodeNodeTypeImpl.NOT);
		// ***************************************************************************************************
		...
		// Rob ADDED breaknode.addchild() to skip notNode.addChild and complete
		// the tree*******************************************************

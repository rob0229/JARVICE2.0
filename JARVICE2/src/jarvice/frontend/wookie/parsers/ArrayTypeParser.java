...
import static jarvice.intermediate.typeimpl.TypeFormImpl.ENUMERATION;
...
class ArrayTypeParser extends TypeSpecificationParser
{
     ...
     */
    protected ArrayTypeParser(WookieParserTD parent)
    {
        super(parent);
    }

    // Synchronization set for the [ token.
    private static final EnumSet<WookieTokenType> LEFT_BRACKET_SET =
    ...
    // Synchronization set for the ] token.
    private static final EnumSet<WookieTokenType> RIGHT_BRACKET_SET =
    ...
    private static final EnumSet<WookieTokenType> INDEX_START_SET =
        SimpleTypeParser.SIMPLE_TYPE_START_SET.clone();
    static {
    ...
    private static final EnumSet<WookieTokenType> INDEX_END_SET =
        EnumSet.of(RIGHT_BRACKET, OF, SEMICOLON);

    // Synchronization set to follow an index type.
    private static final EnumSet<WookieTokenType> INDEX_FOLLOW_SET =

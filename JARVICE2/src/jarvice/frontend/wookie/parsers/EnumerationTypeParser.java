...
public class EnumerationTypeParser extends TypeSpecificationParser
{
     ...
     */
    protected EnumerationTypeParser(WookieParserTD parent)
    {
        super(parent);
    }

    // Synchronization set to start an enumeration constant.
    private static final EnumSet<WookieTokenType> ENUM_CONSTANT_START_SET =
        EnumSet.of(IDENTIFIER, COMMA);

    // Synchronization set to follow an enumeration definition.
    private static final EnumSet<WookieTokenType> ENUM_DEFINITION_FOLLOW_SET =
